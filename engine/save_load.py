...
class SaveManager:
    ...
    def _serialize_engine(self, engine, label: str = "") -> Dict[str, Any]:
        ...
        return {
            ...
            "tribe_camps": self._subsystem_dict(engine, "tribe_camps"),
            "deepdelve": self._subsystem_dict(engine, "deepdelve"),
            "guildhalls": self._subsystem_dict(engine, "guildhalls"),
            "stables": self._subsystem_dict(engine, "stables"),
            "colosseum": self._subsystem_dict(engine, "colosseum"),
            "teleport_network": self._subsystem_dict(engine, "teleport_network"),
            "adventure_tome": self._subsystem_dict(engine, "adventure_tome"),
            "ravenmoor": self._subsystem_dict(engine, "ravenmoor"),
            "emberfell": self._subsystem_dict(engine, "emberfell"),
            "blackbanner": self._subsystem_dict(engine, "blackbanner"),
            "wychwood": self._subsystem_dict(engine, "wychwood"),
            "townsfolk_venture": self._subsystem_dict(engine,
                                                      "townsfolk_venture"),
            "npc_adventuring": self._subsystem_dict(engine, "npc_adventuring"),
            ...
            "wards": self._subsystem_dict(engine, "wards"),
    ...
    def _deserialize_into_engine(self, engine, data: Dict[str, Any]) -> None:
        ...
        for key, attr in (("weather", "weather_system"),
                          ...
                          ("wychwood", "wychwood"),
                          ("townsfolk_venture", "townsfolk_venture"),
                          ("npc_adventuring", "npc_adventuring"),
