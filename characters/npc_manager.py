...
class NPCManager:
    ...
    def create_simple_npcs(self) -> List[Character]:
        """Create some simple NPCs for demo purposes"""
        # Tavern keeper
        ...
        guard = Character(
            ...
            goals=["Protect the village", "Advance in rank", "Enforce the laws"],
        ...
        logger.info("Created 4 NPCs for the demo world")
