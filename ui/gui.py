...
class GameGUI:
    ...
    def render_map_tab(self):
        """Render the map tab with the latest character positions"""
        # Ensure character positions are up-to-date
        self._refresh_character_positions()

        # Get game state with fresh data
        game_state = self.engine.get_game_state()
