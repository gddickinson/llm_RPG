...
CONTROLS: List[Tuple[str, List[Tuple[str, str]]]] = [
    ...
    ("FIGHT", [
        ...
        ("X", "spellbook (SHIFT+N binds a slot)"),
        ("1-5", "quick-cast a slotted spell"),
